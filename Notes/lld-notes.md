...
func (p PercentageSplit) Shares(amt int64, _ []UserID) (map[UserID]int64, error) { return nil, nil }

type ExactSplit struct{ Cents map[UserID]int64 }

func (e ExactSplit) Shares(amt int64, _ []UserID) (map[UserID]int64, error) { return nil, nil }
